# default target
build: condensat-logger condensat-monitor condensat-monitor-stack monitor-webapp bank-api bank-webapp kyc-worker kyc-webhook
...
.PHONY: login build condensat-logger bank-webapp-base condensat-monitor monitor-webapp condensat-monitor-stack bank-api bank-webapp kyc-worker kyc-webhook
